...
CMUnity is an open-source project, where i'll build feature by feature application until reach the main goal: Build a community portal where comunities can manage their own user groups meetups. 

# Journey
Project [CMUnity](https://masterzdran.github.io/cmunity/).
